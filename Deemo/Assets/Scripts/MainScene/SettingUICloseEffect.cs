...
public class SettingUICloseEffect : MonoBehaviour
{
    ...
    private FadeOutSettingObjects script_FadeOutSettingObjects = default;
    private FadeOutSettingPanel script_FadeOutSettingPanel = default;
    ...
    public void Awake()
    {
        ...
        script_FadeOutSettingObjects = obj_Btns.GetComponent<FadeOutSettingObjects>();
        script_FadeOutSettingPanel = obj_SettingUIPanel.GetComponent<FadeOutSettingPanel>();
    }
