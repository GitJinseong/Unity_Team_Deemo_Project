...
public class Choi_SettingButtonEffect : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
{
    ...
    private void Start()
    {
        ...
        originalScale.x = originalScale.x * 1.1f;
        originalScale.y = originalScale.y * 1.1f;
    }
